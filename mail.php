<?php
define('admin_email','noreply@janroceylonspices.com'); // Change admin email here for example admin@yoursite.com
define('website_name','Janro Ceylon Spices'); // Change website name here for example yoursite.com
